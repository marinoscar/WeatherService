...
{
    public class IsoTextMessageEncodingElement : BindingElementExtensionElement
    {
        public IsoTextMessageEncodingElement()
        {
        }
        ...
        public override void ApplyConfiguration(BindingElement bindingElement)
        {
            ...
            var binding = (IsoTextMessageBindingElement)bindingElement;
        ...
        public override Type BindingElementType
        {
            get
            {
                return typeof(IsoTextMessageBindingElement);
            }
        }
